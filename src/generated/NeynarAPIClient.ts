...
import type { AddVerificationReqBody, AuthorizationUrlResponse, AuthorizationUrlResponseType, BanListResponse, BanReqBody, BanResponse, BlockListResponse, BulkCastsResponse, BulkFollowResponse, BulkUsersByAddressResponse, BulkUsersResponse, BuyStorageReqBody, CastComposerActionsListResponse, CastComposerType, CastConversationSortType, CastParamType, CastResponse, CastsResponse, CastsSearchResponse, ChannelFollowReqBody, ChannelListResponse, ChannelMemberInviteListResponse, ChannelMemberListResponse, ChannelResponse, ChannelResponseBulk, ChannelSearchResponse, ChannelType, Conversation, DeleteCastReqBody, DeleteFrameResponse, DeleteNeynarFrameRequest, DeveloperManagedSigner, EmbedType, ErrorRes, FarcasterActionReqBody, FarcasterActionReqBodyAction, FeedResponse, FeedTrendingProvider, FeedType, FetchBulkCastsSortTypeEnum, FetchFrameMetaTagsFromUrl200Response, FetchRepliesAndRecastsForUserFilterEnum, FetchTrendingChannelsTimeWindowEnum, FetchTrendingFeedTimeWindowEnum, FetchValidateFrameAnalyticsAggregateWindowEnum, FilterType, FnameAvailabilityResponse, FollowReqBody, FollowSortType, FollowersResponse, ForYouProvider, Frame, FrameAction, FrameActionReqBody, FrameDeveloperManagedActionReqBody, FrameSignaturePacket, FrameType, FrameValidateAnalyticsResponse, FrameValidateListResponse, LookupCastConversationFoldEnum, MarkNotificationsAsSeenReqBody, MuteListResponse, MuteReqBody, MuteResponse, NeynarFrame, NeynarFrameCreationRequest, NeynarFrameUpdateRequest, NotificationType, NotificationsResponse, OperationResponse, PostCastReqBody, PostCastReqBodyEmbeds, PostCastResponse, ReactionReqBody, ReactionType, ReactionsCastResponse, ReactionsResponse, ReactionsType, RegisterDeveloperManagedSignedKeyReqBody, RegisterSignerKeyReqBody, RegisterUserReqBody, RegisterUserResponse, RelevantFollowersResponse, RemoveChannelMemberRequest, RemoveVerificationReqBody, RespondToChannelInviteRequest, SignedKeyRequestSponsor, Signer, StorageAllocationsResponse, StorageUsageResponse, SubscribedToResponse, SubscribersResponse, SubscriptionProvider, SubscriptionProviders, SubscriptionsResponse, TrendingChannelResponse, UpdateUserReqBody, UpdateUserReqBodyLocation, UserFIDResponse, UserPowerLiteResponse, UserResponse, UserSearchResponse, UsersActiveChannelsResponse, UsersResponse, ValidateFrameActionRequest, ValidateFrameActionResponse, ValidateFrameAnalyticsType, VerificationChainId, VerificationType, WebhookDeleteReqBody, WebhookListResponse, WebhookPatchReqBody, WebhookPatchReqBodyActiveEnum, WebhookPostReqBody, WebhookPutReqBody, WebhookResponse, WebhookSubscriptionFilters } from '../api';
...
export class NeynarAPIClient {
  ...
  constructor(
    ...
    this.apis = {
      actionApi: new ActionApi(config, undefined, axiosInstance),
      banApi: new BanApi(config, undefined, axiosInstance),
      blockApi: new BlockApi(config, undefined, axiosInstance),
      castApi: new CastApi(config, undefined, axiosInstance),
      channelApi: new ChannelApi(config, undefined, axiosInstance),
      feedApi: new FeedApi(config, undefined, axiosInstance),
      fnameApi: new FnameApi(config, undefined, axiosInstance),
      followsApi: new FollowsApi(config, undefined, axiosInstance),
      frameApi: new FrameApi(config, undefined, axiosInstance),
      muteApi: new MuteApi(config, undefined, axiosInstance),
      notificationsApi: new NotificationsApi(config, undefined, axiosInstance),
      reactionApi: new ReactionApi(config, undefined, axiosInstance),
      signerApi: new SignerApi(config, undefined, axiosInstance),
      storageApi: new StorageApi(config, undefined, axiosInstance),
      subscribersApi: new SubscribersApi(config, undefined, axiosInstance),
      userApi: new UserApi(config, undefined, axiosInstance),
      webhookApi: new WebhookApi(config, undefined, axiosInstance),
    };
  }
 ...
 *
 */
public async publishFarcasterAction(params: { signer_uuid: string, base_url: string, action: FarcasterActionReqBodyAction }, options?: RawAxiosRequestConfig): Promise<{ [key: string]: any | undefined; }> {
  const _params = { farcaster_action_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.actionApi.publishFarcasterAction(adjustedParams, options);
 ...
 *
 */
public async deleteBans(params: { fids: Array<number> }, options?: RawAxiosRequestConfig): Promise<BanResponse> {
  const _params = { ban_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.banApi.deleteBans(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async publishBans(params: { fids: Array<number> }, options?: RawAxiosRequestConfig): Promise<BanResponse> {
  const _params = { ban_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.banApi.publishBans(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async deleteCast(params: { signer_uuid: string, target_hash: string }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { delete_cast_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.castApi.deleteCast(adjustedParams, options);
  return response.data;
}
 ...
 * const limit = 
 *
 * client.fetchComposerActionList({list, limit}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async fetchComposerActionList(params: { list: CastComposerType, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<CastComposerActionsListResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.castApi.fetchComposerActionList(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async lookupCastByHashOrWarpcastUrl(params: { identifier: string, type: CastParamType, viewer_fid?: number }, options?: RawAxiosRequestConfig): Promise<CastResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.castApi.lookupCastByHashOrWarpcastUrl(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async lookupCastConversation(params: { identifier: string, type: CastParamType, reply_depth?: number, include_chronological_parent_casts?: boolean, viewer_fid?: number, sort_type?: CastConversationSortType, fold?: LookupCastConversationFoldEnum, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<Conversation> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.castApi.lookupCastConversation(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async publishCast(params: { signer_uuid: string, text?: string, embeds?: Array<PostCastReqBodyEmbeds>, parent?: string, channel_id?: string, idem?: string, parent_author_fid?: number }, options?: RawAxiosRequestConfig): Promise<PostCastResponse> {
  const _params = { post_cast_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.castApi.publishCast(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async searchCasts(params: { q: string, author_fid?: number, viewer_fid?: number, parent_url?: string, channel_id?: string, priority_mode?: boolean, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<CastsSearchResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.castApi.searchCasts(adjustedParams, options);
  return response.data;
}
 ...
 * @param {boolean} params.has_root_cast_authors  - Include users who posted the root cast in the channel
 * @param {boolean} params.has_cast_likers [optional]  - Include users who liked a cast in the channel
 * @param {boolean} params.has_cast_recasters [optional]  - Include users who recasted a cast in the channel
 * @param {boolean} params.has_reply_authors [optional]  - Include users who replied to a cast in the channel
 * @param {string} params.cursor [optional]  - Pagination cursor.
 * @param {number} params.limit [optional]  - Number of results to fetch (Default: 25, Maximum: 100)
 *
 ...
 * // Fill in the appropriate values
 * const id = 
 * const has_root_cast_authors = 
 * const has_cast_likers = 
 * const has_cast_recasters = 
 * const has_reply_authors = 
 * const limit = 
 *
 * client.fetchActiveUsersInSingleChannel({id, has_root_cast_authors, has_cast_likers, has_cast_recasters, has_reply_authors, limit}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async fetchActiveUsersInSingleChannel(params: { id: string, has_root_cast_authors: boolean, has_cast_likers?: boolean, has_cast_recasters?: boolean, has_reply_authors?: boolean, cursor?: string, limit?: number }, options?: RawAxiosRequestConfig): Promise<UsersResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.fetchActiveUsersInSingleChannel(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchAllChannels(params: { limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<ChannelListResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.fetchAllChannels(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchBulkChannels(params: { ids: string, type?: ChannelType, viewer_fid?: number }, options?: RawAxiosRequestConfig): Promise<ChannelResponseBulk> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.fetchBulkChannels(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchChannelInvites(params: { channel_id?: string, invited_fid?: number, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<ChannelMemberInviteListResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.fetchChannelInvites(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchTrendingChannels(params: { time_window?: FetchTrendingChannelsTimeWindowEnum, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<TrendingChannelResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.fetchTrendingChannels(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchUserChannelMemberships(params: { fid: number, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<ChannelMemberListResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.fetchUserChannelMemberships(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchUserChannels(params: { fid: number, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<ChannelListResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.fetchUserChannels(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchUsersActiveChannels(params: { fid: number, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<UsersActiveChannelsResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.fetchUsersActiveChannels(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async followChannel(params: { signer_uuid: string, channel_id: string }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { channel_follow_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.channelApi.followChannel(adjustedParams, options);
  return response.data;
}
 ...
 *
 * @param {object} params
 * @param {RemoveChannelMemberRequest} params.remove_channel_member_request 
 *
 * @returns {Promise<OperationResponse>} A promise that resolves to a `OperationResponse` object.
 *
 * @example
 *
 * // Fill in the appropriate values
 * const remove_channel_member_request = 
 *
 * client.inviteMemberToChannel({remove_channel_member_request}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async inviteMemberToChannel(params: { remove_channel_member_request: RemoveChannelMemberRequest }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.inviteMemberToChannel(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async lookupChannel(params: { id: string, type?: ChannelType, viewer_fid?: number }, options?: RawAxiosRequestConfig): Promise<ChannelResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.lookupChannel(adjustedParams, options);
  return response.data;
}
 ...
 * const remove_channel_member_request = 
 *
 * client.removeChannelMember({remove_channel_member_request}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async removeChannelMember(params: { remove_channel_member_request: RemoveChannelMemberRequest }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.removeChannelMember(adjustedParams, options);
  return response.data;
}
 ...
 *
 * @param {object} params
 * @param {RespondToChannelInviteRequest} params.respond_to_channel_invite_request 
 *
 * @returns {Promise<OperationResponse>} A promise that resolves to a `OperationResponse` object.
 *
 * @example
 *
 * // Fill in the appropriate values
 * const respond_to_channel_invite_request = 
 *
 * client.respondToChannelInvite({respond_to_channel_invite_request}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async respondToChannelInvite(params: { respond_to_channel_invite_request: RespondToChannelInviteRequest }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.respondToChannelInvite(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async searchChannels(params: { q: string, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<ChannelSearchResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.channelApi.searchChannels(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async unfollowChannel(params: { signer_uuid: string, channel_id: string }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { channel_follow_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.channelApi.unfollowChannel(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchCastsForUser(params: { fid: number, viewer_fid?: number, limit?: number, cursor?: string, include_replies?: boolean, parent_url?: string, channel_id?: string }, options?: RawAxiosRequestConfig): Promise<FeedResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchCastsForUser(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchFeed(params: { feed_type: FeedType, filter_type?: FilterType, fid?: number, fids?: string, parent_url?: string, channel_id?: string, members_only?: boolean, embed_url?: string, embed_types?: Array<EmbedType>, with_recasts?: boolean, limit?: number, cursor?: string, viewer_fid?: number }, options?: RawAxiosRequestConfig): Promise<FeedResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchFeed(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchFeedByChannelIds(params: { channel_ids: string, with_recasts?: boolean, viewer_fid?: number, with_replies?: boolean, members_only?: boolean, limit?: number, cursor?: string, should_moderate?: boolean }, options?: RawAxiosRequestConfig): Promise<FeedResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchFeedByChannelIds(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchFeedByParentUrls(params: { parent_urls: string, with_recasts?: boolean, viewer_fid?: number, with_replies?: boolean, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<FeedResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchFeedByParentUrls(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchFeedForYou(params: { fid: number, viewer_fid?: number, provider?: ForYouProvider, limit?: number, cursor?: string, provider_metadata?: string }, options?: RawAxiosRequestConfig): Promise<FeedResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchFeedForYou(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchFramesOnlyFeed(params: { limit?: number, viewer_fid?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<FeedResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchFramesOnlyFeed(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchPopularCastsByUser(params: { fid: number, viewer_fid?: number }, options?: RawAxiosRequestConfig): Promise<BulkCastsResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchPopularCastsByUser(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchRepliesAndRecastsForUser(params: { fid: number, filter?: FetchRepliesAndRecastsForUserFilterEnum, limit?: number, cursor?: string, viewer_fid?: number }, options?: RawAxiosRequestConfig): Promise<FeedResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchRepliesAndRecastsForUser(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchTrendingFeed(params: { limit?: number, cursor?: string, viewer_fid?: number, time_window?: FetchTrendingFeedTimeWindowEnum, channel_id?: string, provider?: FeedTrendingProvider, provider_metadata?: string }, options?: RawAxiosRequestConfig): Promise<FeedResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchTrendingFeed(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchUserFollowingFeed(params: { fid: number, viewer_fid?: number, with_recasts?: boolean, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<FeedResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.feedApi.fetchUserFollowingFeed(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async isFnameAvailable(params: { fname: string }, options?: RawAxiosRequestConfig): Promise<FnameAvailabilityResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.fnameApi.isFnameAvailable(adjustedParams, options);
  return response.data;
}
 ...
 * const limit = 
 *
 * client.fetchUserFollowingV2({fid, viewer_fid, sort_type, limit}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async fetchUserFollowingV2(params: { fid: number, viewer_fid?: number, sort_type?: FollowSortType, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<FollowersResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.followsApi.fetchUserFollowingV2(adjustedParams, options);
  return response.data;
}
 ...
 *
 * @param {object} params
 * @param {DeleteNeynarFrameRequest} params.delete_neynar_frame_request 
 *
 ...
 *
 * // Fill in the appropriate values
 * const delete_neynar_frame_request = 
 *
 * client.deleteNeynarFrame({delete_neynar_frame_request}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async deleteNeynarFrame(params: { delete_neynar_frame_request: DeleteNeynarFrameRequest }, options?: RawAxiosRequestConfig): Promise<DeleteFrameResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.frameApi.deleteNeynarFrame(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchFrameMetaTagsFromUrl(params: { url: string }, options?: RawAxiosRequestConfig): Promise<FetchFrameMetaTagsFromUrl200Response> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.frameApi.fetchFrameMetaTagsFromUrl(adjustedParams, options);
  return response.data;
}
 ...
 * @param {FetchValidateFrameAnalyticsAggregateWindowEnum} params.aggregate_window [optional]  - Required for `analytics_type=interactions-per-cast`
 *
 ...
 *
 */
public async fetchValidateFrameAnalytics(params: { frame_url: string, analytics_type: ValidateFrameAnalyticsType, start: string, stop: string, aggregate_window?: FetchValidateFrameAnalyticsAggregateWindowEnum }, options?: RawAxiosRequestConfig): Promise<FrameValidateAnalyticsResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.frameApi.fetchValidateFrameAnalytics(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchValidateFrameList(options?: RawAxiosRequestConfig): Promise<FrameValidateListResponse> {
  
  const response = await this.apis.frameApi.fetchValidateFrameList(options);
  return response.data;
}
 ...
 *
 */
public async lookupNeynarFrame(params: { type: FrameType, uuid?: string, url?: string }, options?: RawAxiosRequestConfig): Promise<NeynarFrame> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.frameApi.lookupNeynarFrame(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async postFrameAction(params: { signer_uuid: string, cast_hash?: string, action: FrameAction }, options?: RawAxiosRequestConfig): Promise<Frame> {
  const _params = { frame_action_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.frameApi.postFrameAction(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async postFrameActionDeveloperManaged(params: { cast_hash?: string, action: FrameAction, signature_packet: FrameSignaturePacket }, options?: RawAxiosRequestConfig): Promise<Frame> {
  const _params = { frame_developer_managed_action_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.frameApi.postFrameActionDeveloperManaged(adjustedParams, options);
  return response.data;
}
 ...
 *
 * @param {object} params
 * @param {NeynarFrameCreationRequest} params.neynar_frame_creation_request 
 *
 * @returns {Promise<NeynarFrame>} A promise that resolves to a `NeynarFrame` object.
 *
 * @example
 *
 * // Fill in the appropriate values
 * const neynar_frame_creation_request = 
 *
 * client.publishNeynarFrame({neynar_frame_creation_request}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async publishNeynarFrame(params: { neynar_frame_creation_request: NeynarFrameCreationRequest }, options?: RawAxiosRequestConfig): Promise<NeynarFrame> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.frameApi.publishNeynarFrame(adjustedParams, options);
  return response.data;
}
 ...
 *
 * @param {object} params
 * @param {NeynarFrameUpdateRequest} params.neynar_frame_update_request 
 *
 * @returns {Promise<NeynarFrame>} A promise that resolves to a `NeynarFrame` object.
 *
 * @example
 *
 * // Fill in the appropriate values
 * const neynar_frame_update_request = 
 *
 * client.updateNeynarFrame({neynar_frame_update_request}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async updateNeynarFrame(params: { neynar_frame_update_request: NeynarFrameUpdateRequest }, options?: RawAxiosRequestConfig): Promise<NeynarFrame> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.frameApi.updateNeynarFrame(adjustedParams, options);
  return response.data;
}
 ...
 *
 * @param {object} params
 * @param {ValidateFrameActionRequest} params.validate_frame_action_request 
 *
 ...
 *
 * // Fill in the appropriate values
 * const validate_frame_action_request = 
 *
 * client.validateFrameAction({validate_frame_action_request}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async validateFrameAction(params: { validate_frame_action_request: ValidateFrameActionRequest }, options?: RawAxiosRequestConfig): Promise<ValidateFrameActionResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.frameApi.validateFrameAction(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async deleteMute(params: { fid: number, muted_fid: number }, options?: RawAxiosRequestConfig): Promise<MuteResponse> {
  const _params = { mute_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.muteApi.deleteMute(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async publishMute(params: { fid: number, muted_fid: number }, options?: RawAxiosRequestConfig): Promise<MuteResponse> {
  const _params = { mute_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.muteApi.publishMute(adjustedParams, options);
  return response.data;
}
 ...
 * @param {NotificationType} params.type [optional]  - Notification type to fetch.
 ...
 *
 */
public async fetchAllNotifications(params: { fid: number, type?: NotificationType, priority_mode?: boolean, cursor?: string }, options?: RawAxiosRequestConfig): Promise<NotificationsResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.notificationsApi.fetchAllNotifications(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchChannelNotificationsForUser(params: { fid: number, channel_ids: string, priority_mode?: boolean, cursor?: string }, options?: RawAxiosRequestConfig): Promise<NotificationsResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.notificationsApi.fetchChannelNotificationsForUser(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchNotificationsByParentUrlForUser(params: { fid: number, parent_urls: string, priority_mode?: boolean, cursor?: string }, options?: RawAxiosRequestConfig): Promise<NotificationsResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.notificationsApi.fetchNotificationsByParentUrlForUser(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async markNotificationsAsSeen(params: { signer_uuid: string, type?: NotificationType }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { mark_notifications_as_seen_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.notificationsApi.markNotificationsAsSeen(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async deleteReaction(params: { signer_uuid: string, reaction_type: ReactionType, target: string, target_author_fid?: number, idem?: string }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { reaction_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.reactionApi.deleteReaction(adjustedParams, options);
  return response.data;
}
 ...
 * @param {string} params.types  - Customize which reaction types the request should search for. This is a comma-separated string that can include the following values: 'likes' and 'recasts'. By default api returns both. To select multiple types, use a comma-separated list of these values.
 ...
 *
 */
public async fetchCastReactions(params: { hash: string, types: string, viewer_fid?: number, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<ReactionsCastResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.reactionApi.fetchCastReactions(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchUserReactions(params: { fid: number, type: ReactionsType, viewer_fid?: number, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<ReactionsResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.reactionApi.fetchUserReactions(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async publishReaction(params: { signer_uuid: string, reaction_type: ReactionType, target: string, target_author_fid?: number, idem?: string }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { reaction_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.reactionApi.publishReaction(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async createSigner(options?: RawAxiosRequestConfig): Promise<Signer> {
  
  const response = await this.apis.signerApi.createSigner(options);
  return response.data;
}
 ...
 *
 */
public async fetchAuthorizationUrl(params: { client_id: string, response_type: AuthorizationUrlResponseType }, options?: RawAxiosRequestConfig): Promise<AuthorizationUrlResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.signerApi.fetchAuthorizationUrl(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async lookupDeveloperManagedSigner(params: { public_key: string }, options?: RawAxiosRequestConfig): Promise<DeveloperManagedSigner> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.signerApi.lookupDeveloperManagedSigner(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async lookupSigner(params: { signer_uuid: string }, options?: RawAxiosRequestConfig): Promise<Signer> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.signerApi.lookupSigner(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async publishMessageToFarcaster(params: { body: object }, options?: RawAxiosRequestConfig): Promise<object> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.signerApi.publishMessageToFarcaster(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async registerSignedKey(params: { signer_uuid: string, signature: string, app_fid: number, deadline: number, redirect_url?: string, sponsor?: SignedKeyRequestSponsor }, options?: RawAxiosRequestConfig): Promise<Signer> {
  const _params = { register_signer_key_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.signerApi.registerSignedKey(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async registerSignedKeyForDeveloperManagedSigner(params: { public_key: string, signature: string, app_fid: number, deadline: number, redirect_url?: string, sponsor?: SignedKeyRequestSponsor }, options?: RawAxiosRequestConfig): Promise<DeveloperManagedSigner> {
  const _params = { register_developer_managed_signed_key_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.signerApi.registerSignedKeyForDeveloperManagedSigner(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async buyStorage(params: { fid: number, units?: number, idem?: string }, options?: RawAxiosRequestConfig): Promise<StorageAllocationsResponse> {
  const _params = { buy_storage_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.storageApi.buyStorage(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async lookupUserStorageAllocations(params: { fid: number }, options?: RawAxiosRequestConfig): Promise<StorageAllocationsResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.storageApi.lookupUserStorageAllocations(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async lookupUserStorageUsage(params: { fid: number }, options?: RawAxiosRequestConfig): Promise<StorageUsageResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.storageApi.lookupUserStorageUsage(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchSubscribedToForFid(params: { fid: number, subscription_provider: SubscriptionProvider, viewer_fid?: number }, options?: RawAxiosRequestConfig): Promise<SubscribedToResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.subscribersApi.fetchSubscribedToForFid(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchSubscribersForFid(params: { fid: number, subscription_provider: SubscriptionProviders, viewer_fid?: number }, options?: RawAxiosRequestConfig): Promise<SubscribersResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.subscribersApi.fetchSubscribersForFid(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchSubscriptionsForFid(params: { fid: number, subscription_provider: SubscriptionProvider }, options?: RawAxiosRequestConfig): Promise<SubscriptionsResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.subscribersApi.fetchSubscriptionsForFid(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async deleteVerification(params: { signer_uuid: string, address: string }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { remove_verification_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.userApi.deleteVerification(adjustedParams, options);
  return response.data;
}
...
if (adjustedParams.fids && Array.isArray(adjustedParams.fids)) {
  ...
  const response = await this.apis.userApi.fetchBulkUsers(adjustedParams, options);
  return response.data;
}
...
public async fetchBulkUsersByEthereumAddress(params: { addresses: string, address_types?: string, viewer_fid?: number }, options?: RawAxiosRequestConfig): Promise<BulkUsersByAddressResponse> {
  ...
  const response = await this.apis.userApi.fetchBulkUsersByEthereumAddress(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async followUser(params: { signer_uuid: string, target_fids: Array<number> }, options?: RawAxiosRequestConfig): Promise<BulkFollowResponse> {
  const _params = { follow_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.userApi.followUser(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async lookupUserByCustodyAddress(params: { custody_address: string }, options?: RawAxiosRequestConfig): Promise<UserResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.userApi.lookupUserByCustodyAddress(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async publishVerification(params: { signer_uuid: string, address: string, block_hash: string, eth_signature: string, verification_type?: VerificationType, chain_id?: VerificationChainId }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { add_verification_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.userApi.publishVerification(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async registerAccount(params: { signature: string, fid: number, requested_user_custody_address: string, deadline: number, fname?: string }, options?: RawAxiosRequestConfig): Promise<RegisterUserResponse> {
  const _params = { register_user_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.userApi.registerAccount(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async unfollowUser(params: { signer_uuid: string, target_fids: Array<number> }, options?: RawAxiosRequestConfig): Promise<BulkFollowResponse> {
  const _params = { follow_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.userApi.unfollowUser(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async updateUser(params: { signer_uuid: string, bio?: string, pfp_url?: string, url?: string, username?: string, display_name?: string, location?: UpdateUserReqBodyLocation }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { update_user_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.userApi.updateUser(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async deleteWebhook(params: { webhook_id: string }, options?: RawAxiosRequestConfig): Promise<WebhookResponse> {
  const _params = { webhook_delete_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.webhookApi.deleteWebhook(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchWebhooks(options?: RawAxiosRequestConfig): Promise<WebhookListResponse> {
  
  const response = await this.apis.webhookApi.fetchWebhooks(options);
  return response.data;
}
 ...
 *
 */
public async lookupWebhook(params: { webhook_id: string }, options?: RawAxiosRequestConfig): Promise<WebhookResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.webhookApi.lookupWebhook(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async publishWebhook(params: { name: string, url: string, subscription?: WebhookSubscriptionFilters }, options?: RawAxiosRequestConfig): Promise<WebhookResponse> {
  const _params = { webhook_post_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.webhookApi.publishWebhook(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async updateWebhook(params: { name: string, url: string, subscription?: WebhookSubscriptionFilters, webhook_id: string }, options?: RawAxiosRequestConfig): Promise<WebhookResponse> {
  const _params = { webhook_put_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.webhookApi.updateWebhook(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async updateWebhookActiveStatus(params: { webhook_id: string, active: WebhookPatchReqBodyActiveEnum }, options?: RawAxiosRequestConfig): Promise<WebhookResponse> {
  const _params = { webhook_patch_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.webhookApi.updateWebhookActiveStatus(adjustedParams, options);
  return response.data;
}
}
