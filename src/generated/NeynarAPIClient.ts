 ...
 *
 */
public async publishFarcasterAction(params: { signer_uuid: string, base_url: string, action: FarcasterActionReqBodyAction }, options?: RawAxiosRequestConfig): Promise<{ [key: string]: any; }> {
 ...
 *
 */
public async deleteBlock(params: { signer_uuid: string, blocked_fid: number }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { block_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.blockApi.deleteBlock(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async publishBlock(params: { signer_uuid: string, blocked_fid: number }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { block_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.blockApi.publishBlock(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async fetchComposerActions(params: { list: CastComposerType, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<CastComposerActionsListResponse> {
  const adjustedParams: any = { ...params };

  const response = await this.apis.castApi.fetchComposerActions(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async inviteChannelMember(params: { signer_uuid: string, channel_id: string, fid: number, role: ChannelMemberRole }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { invite_channel_member_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.channelApi.inviteChannelMember(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async removeChannelMember(params: { signer_uuid: string, channel_id: string, fid: number, role: ChannelMemberRole }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
 ...
 *
 */
public async respondChannelInvite(params: { signer_uuid: string, channel_id: string, role: ChannelMemberRole, accept: boolean }, options?: RawAxiosRequestConfig): Promise<OperationResponse> {
  const _params = { respond_channel_invite_req_body: params };
const adjustedParams: any = { ..._params };

  const response = await this.apis.channelApi.respondChannelInvite(adjustedParams, options);
  return response.data;
}
 ...
 *
 */
public async deleteNeynarFrame(params: { uuid?: string }, options?: RawAxiosRequestConfig): Promise<DeleteFrameResponse> {
 ...
 *
 */
public async publishNeynarFrame(params: { name: string, pages: Array<NeynarFramePage> }, options?: RawAxiosRequestConfig): Promise<NeynarFrame> {
 ...
 *
 */
public async updateNeynarFrame(params: { uuid: string, name?: string, pages: Array<NeynarFramePage> }, options?: RawAxiosRequestConfig): Promise<NeynarFrame> {
 ...
 *
 */
public async validateFrameAction(params: { message_bytes_in_hex: string, cast_reaction_context?: boolean, follow_context?: boolean, signer_context?: boolean, channel_follow_context?: boolean }, options?: RawAxiosRequestConfig): Promise<ValidateFrameActionResponse> {
 ...
 * @param {string[]} params.type [optional]  - Notification type to fetch. Comma separated values of follows, recasts, likes, mentions, replies.
 ...
 *
 */
public async fetchAllNotifications(params: { fid: number, type?: string[], priority_mode?: boolean, cursor?: string }, options?: RawAxiosRequestConfig): Promise<NotificationsResponse> {
  const adjustedParams: any = { ...params };
if (adjustedParams.type && Array.isArray(adjustedParams.type)) {
  adjustedParams.type = adjustedParams.type.join(",");
}
...
public async fetchCastReactions(params: { hash: string, types: string[], viewer_fid?: number, limit?: number, cursor?: string }, options?: RawAxiosRequestConfig): Promise<ReactionsCastResponse> {
  const adjustedParams: any = { ...params };
if (adjustedParams.types && Array.isArray(adjustedParams.types)) {
  adjustedParams.types = adjustedParams.types.join(",");
}
 ...
 *
 * @param {object} params
 * @param {string} params.x_experiments_enabled  - Enable experimental features
 ...
 * const sponsor = 
 *
 * client.registerSignedKeyForDeveloperManagedSigner({x_experiments_enabled, public_key, signature, app_fid, deadline, redirect_url, sponsor}).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async registerSignedKeyForDeveloperManagedSigner(params: { x_experiments_enabled: string, public_key: string, signature: string, app_fid: number, deadline: number, redirect_url?: string, sponsor?: SignedKeyRequestSponsor }, options?: RawAxiosRequestConfig): Promise<DeveloperManagedSigner> {
...
if (adjustedParams.address_types && Array.isArray(adjustedParams.address_types)) {
  adjustedParams.address_types = adjustedParams.address_types.join(",");
}
